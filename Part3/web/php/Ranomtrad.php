...
<?php 
        ...
        $sql = "delete from anomalia where idanomalia=$id;";
        $sql2 = "delete from anomaliatraducao where idanomaliatraducao=$id;";
        ...
        echo("<p>Removed Traduction Anomaly $id with success.</p>");
